...
from .dataset_nerfstudio import DatasetNerfstudio, DatasetNerfstudioCfg
...
DATASETS: dict[str, Dataset] = {
    "re10k": DatasetRE10k,
    "dl3dv": DatasetDL3DV,
    "nerfstudio": DatasetNerfstudio,
}


DatasetCfg = DatasetRE10kCfg | DatasetDL3DVCfg | DatasetNerfstudioCfg
